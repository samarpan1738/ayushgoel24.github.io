...
const StyledGrid = styled.div`
  ...
  .projects {
    ...
    grid-gap: 5px;
    position: relative;
    ${media.desktop`grid-template-columns: repeat(auto-fill, minmax(225px, 1fr));`};
  }
`;
        ...
        <TransitionGroup className="projects">
          {projectsToShow &&
            projectsToShow.map(({ node }, i) => {
              ...
              const { course, institute, company, github, external, tech } = frontmatter;
              return (
                <CSSTransition
                  key={i}
                  classNames="fadeup"
                  ...
                  <StyledProject
                    ...
                    <StyledProjectInner>
                      <header>
                        ...
                        <StyledProjectName>{course}</StyledProjectName>
                        <StyledProjectInstitute>{institute}
                        </StyledProjectInstitute>
